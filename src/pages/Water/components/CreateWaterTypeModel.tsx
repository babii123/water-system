...
import { getUserListByAPI } from '../../../store/actions/userListActions';
...
const CreateWaterTypeModel: React.FC<{ controlModel?: ControlModel, changeControl: Function, updateWaterTypeInfo?: WaterTypeDataType }> = ({ controlModel, changeControl, updateWaterTypeInfo }) => {
