...
export const createWaterStorage_API = (data: waterStorage) => request.post<WaterStorageData>(`${basic_path}`, data)
...
export const updateWaterStorage_API = (id: number, data: waterStorage) => request.patch(`${basic_path}/${id}`, data)
